...
== PROJECT STATUS
Puppi has been originally designed to automate deployments in
...
Puppi command first incarnation has been written in bash by Alessandro Franceschi a new pure ruby
version is under development by Celso Fernandez and is going to be incorporated in the Puppi module.
